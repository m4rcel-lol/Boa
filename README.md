...
boa install /usr/local/bin/boa --force
...
`install` copies the current Boa executable/script to the path you provide, and `--force` overwrites an existing destination.
